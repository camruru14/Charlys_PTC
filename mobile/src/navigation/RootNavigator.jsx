...
// Punto de entrada de la navegación: sin sesión, solo LoginScreen; con
// sesión, el Drawer con las 10 secciones, más las 7 pantallas de formulario
// de la Fase 3 (crear/editar en Fabricación, Finanzas, Logística, Empleados
// y Catálogo) registradas como un grupo modal — cada una trae su propio
// header (Cancelar/Guardar, ver useSaveCancelHeader) en vez del header del
// Drawer — y el detalle de un pedido (Fase 4), un push normal aparte. App.js
// ya se encarga de mostrar un indicador de carga mientras AuthContext
// resuelve si hay sesión guardada, así que acá `isAuthenticated` ya es un
// valor definitivo.
