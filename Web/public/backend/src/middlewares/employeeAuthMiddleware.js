...
// eliminar productos e imágenes): usa la MISMA sesión de empleado que el
// panel privado ("authCookie", firmada con el JWT_Secret_key de empleados —
// mismo .env, misma base de datos) vía cookie httpOnly (private/frontend) o
// header Authorization: Bearer (app móvil), en vez de una llave estática por
// header. Así cualquier empleado ya autenticado puede administrar el
// catálogo desde ahí mismo, sin un mecanismo de auth aparte.
