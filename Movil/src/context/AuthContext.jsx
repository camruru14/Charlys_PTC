...
export function AuthProvider({ children }) {
  ...
  // Se pone en true justo después de un login exitoso (no al restaurar una
  // sesión guardada al abrir la app, esa ya la cubre el splash nativo de
  // App.js): RootNavigator lo usa para intercalar PostLoginSplashScreen
  ...
  // PostLoginSplashScreen la llama apenas termina de mostrarse, para volver
  // al criterio normal (isAuthenticated sin justLoggedIn) y que RootNavigator
  // muestre el Drawer.
